...
from utils import SatelliteDataset, config_to_object
...
class LitDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        dataset_class = SatelliteDataset
        if stage in ("fit", None):
            if self.hparams["train_fold"] is not None:
                train_set = self.hparams["groups"][self.hparams["train_fold"]]
            else:
                train_set = list(
                    chain(
                        *[
