...
from lightning_modules import CaliforniaDataModule, LitDataModule, LitModel
...
def get_args():
    ...
    parser.add_argument("--config_file", default="configs/UnifiedFocal_Magnifier.yaml")
    parser.add_argument("--ckpt_path", default=None)
    parser.add_argument("--test_set", default="3")
    parser.add_argument(
        "--run_type",
        choices=["burned_areas", "california"],
        default="california",
    )
...
def train():
    ...
    if args.run_type == "burned_areas":
        datamodule = LitDataModule(**dataset_config)
    elif args.run_type == "california":
